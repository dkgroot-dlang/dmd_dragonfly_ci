...
echo "________________________________________________________________________"
curl -s https://raw.githubusercontent.com/dkgroot-dlang/dmd_dragonfly_ci/master/scripts/inputrc -o /mnt/usr/local/etc/inputrc
curl -s https://raw.githubusercontent.com/dkgroot-dlang/dmd_dragonfly_ci/master/scripts/bash.bashrc -o /mnt/usr/local/etc/bash.bashrc
cp /mnt/usr/local/etc/bash.bashrc /mnt/root/.bashrc
cp /mnt/usr/local/etc/bash.bashrc /mnt/home/${username}/.bashrc
curl -s https://raw.githubusercontent.com/dkgroot-dlang/dmd_dragonfly_ci/master/scripts/profile -o /mnt/usr/local/etc/profile
