...
df.expect('>>> ')
df.sendline("curl -s https://raw.githubusercontent.com/dkgroot-dlang/dmd_dragonfly_ci/master/scripts/install_dfly.sh -o install_dfly.sh")
df.expect(">>> ")
